...
#define MSF_MAGIC_SIZE Max(sizeof(msf_msf20_magic), sizeof(msf_msf70_magic))

#define MSF_MIN_SIZE Min(sizeof(msf_msf20_magic) + sizeof(MSF_Header20), sizeof(msf_msf70_magic) + sizeof(MSF_Header70))
